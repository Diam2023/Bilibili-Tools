...
class AdminTable
{
  public:
     ...
     */
    explicit AdminTable(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AdminTable(const Json::Value &pJson) noexcept(false);
     ...
     */
    AdminTable(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<AdminTable>;
    friend drogon::orm::BaseBuilder<AdminTable, true, true>;
    friend drogon::orm::BaseBuilder<AdminTable, true, false>;
    friend drogon::orm::BaseBuilder<AdminTable, false, true>;
    friend drogon::orm::BaseBuilder<AdminTable, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<AdminTable>;
#endif
